...
| F4 Service/restricted profiles | IN_PROGRESS | `f85ea0b` | F4a committed `f85ea0b`; F4b pending. 89 profile/process/hook tests pass; the MCP service, launcher and live isolation smoke are F4b |
