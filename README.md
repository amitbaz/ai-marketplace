...
| --- | --- | --- |
| [groundwork](./plugins/groundwork) | 1.7.0 | Extension for `obra/superpowers` that adds parallel reconnaissance, discussion, and planning before committing to code. **Requires Superpowers.** |
